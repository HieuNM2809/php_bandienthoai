        ...
        <div class="container text-light">
            <div class="w-100 d-flex justify-content-between">
                <div>
                    ...
                    <a class="navbar-sm-brand text-light text-decoration-none" href="tel:070-375-xxxx">070375xxx</a>
                </div>
                <div>
                    <a class="text-light" href="https://www.facebook.com/laihong.khai.5" target="_blank"
    ...
    <nav class="navbar navbar-expand-lg navbar-light shadow">
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <a class="navbar-brand text-success logo h1 align-self-center" href="index.html">
                <img src="/assets/img/OneWeek.png" alt="" style="width:40%;">
            </a>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 pt-5">
                    <a class="navbar-brand text-success logo h1 align-self-center" href="index.html">
                        <img src="/assets/img/OneWeek2.png" alt="" style="width:40%;">
                    </a>
