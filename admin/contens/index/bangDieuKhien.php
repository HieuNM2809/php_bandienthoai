            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-4 col-xlg-3">
                        <a href="<?php echo $level.pages_Part."charts.php" ?>">
                            <div class="card card-hover">
                     ...
                     <!-- Column -->
                    <div class="col-md-6 col-lg-2 col-xlg-3">
                        <a href="<?php echo $level.pages_Part."ListStaff.php" ?>">
                            <div class="card card-hover">
                        ...
                        <a href="<?php echo $level.pages_Part."Order.php" ?>">
                            <div class="card card-hover">
                                <div class="box bg-info text-center">
                                    ...
                                    <h6 class="text-white">Đơn nhập </h6>
                                </div>
                            </div>
                        </a>   
                    </div>
                    ...
                    <div class="col-md-12 col-lg-6 col-xlg-6">
                        <a href="<?php echo $level.pages_Part."ListPurchaseMenu.php" ?>">
                            <div class="card card-hover">
                                <div class="box bg-danger text-center">
                                    <h1 class="font-light text-white"><i class="mdi mdi-receipt"></i></h1>
                                    <h6 class="text-white">Đơn mua</h6>
                                </div>
                            </div>
                        </a>    
                    </div>
